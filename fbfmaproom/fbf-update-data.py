...
url_datasets = [
    ...
    (
        "djibouti/spi-jjas",
        "https://iridl.ldeo.columbia.edu/SOURCES/.UCSB/.CHIRPS/.v2p0/.daily-improved/.global/.0p25/.prcp/X/41.625/43.375/RANGE/Y/10.875/12.875/RANGE/monthlyAverage/30/mul/a%3A/4/gamma3par/pcpn_accum/gmean/gsd/gskew/pzero/4/gammaprobs/4/gammastandardize/T//pointwidth/4/def//defaultvalue/%7Blast%7D/def/-1.5/shiftGRID//long_name/(Standardized%20Precipitation%20Index)/def/%3Aa%3A/T/4/runningAverage/T/12/splitstreamgrid/0./flaggt/%5BT2%5Daverage/1./3./div/flaggt/1./masklt/%5BT%5D/REORDER/CopyStream/%3Aa/mul/DATA/-3/3/RANGE//name//spi/def/T/(Jun-Sep%201981)/last/12/RANGESTEP/",
    ),
    (
        "djibouti/wrsi-ond",
