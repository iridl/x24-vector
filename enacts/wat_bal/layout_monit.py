                ...
                [
                    ...
                    Block(
                        ...
                        Sentence(
                            ...
                            Number("kc_init", 0, min=0, max=2),
                            "through",
                            Number("kc_init_length", 3, min=0, max=99),
                            "days of initialization to",
                            Number("kc_veg", 0, min=0, max=2),
                            "through",
                            Number("kc_veg_length", 27, min=0, max=99),
                            "days of vegetative growth to",
                            Number("kc_mid", 1.1, min=0, max=2),
                            "through",
                            Number("kc_mid_length", 45, min=0, max=99),
                            "days of mid-season to",
                            Number("kc_late", 1.1, min=0, max=2),
                            "through",
                            Number("kc_late_length", 60, min=0, max=99),
                            "days of late-season to",
                            Number("kc_end", 0, min=0, max=2),
                        ),
                    ),
                ],
