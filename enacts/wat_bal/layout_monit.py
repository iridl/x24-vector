            ...
            html.Div(
                [
                    ...
                    Block(
                        ...
                        Sentence(
                            Number("kc_init", 0, min=0, max=2, html_size=4),
                            "through",
                            Number("kc_init_length", 3, min=0, max=99, html_size=2),
                            "days of initialization to",
                        ),
                        Sentence(
                            Number("kc_veg", 0, min=0, max=2, html_size=4),
                            "through",
                            Number("kc_veg_length", 27, min=0, max=99, html_size=2),
                            "days of growth to",
                        ),
                        Sentence(
                            Number("kc_mid", 1.1, min=0, max=2, html_size=4),
                            "through",
                            Number("kc_mid_length", 45, min=0, max=99, html_size=2),
                            "days of mid-season to",
                        ),
                        Sentence(
                            Number("kc_late", 1.1, min=0, max=2, html_size=4),
                            "through",
                            Number("kc_late_length", 60, min=0, max=99, html_size=2),
